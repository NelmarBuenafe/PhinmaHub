      ...
      <section className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <form className="mt-8" onSubmit={submit}>
            ...
            <input
              autoComplete="off"
              className="mt-2 w-full rounded-xl border border-slate-300 px-4 py-3 uppercase tracking-wider outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-100"
              id="join-code"
              maxLength={32}
