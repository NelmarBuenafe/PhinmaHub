...
function RoleCard({ description, icon: Icon, onSelect, selected, title }) {
  return (
    <article
      className={`ph-interactive-card flex h-full flex-col rounded-3xl p-6 focus-within:ring-2 focus-within:ring-emerald-500 ${selected ? "border-emerald-600 ring-2 ring-emerald-100" : "border-slate-200"}`}
    >
